...
>
> 文档快照：master 分支 `500fcef7ddac917135349d82283a5a3ce8fb5604`，整理日期：2026-07-09
...
Kubernetes Dynamic Resource Allocation 在 v1.34 进入 GA。DRA 提供 `ResourceClaim`、`DeviceClass`、`ResourceSlice` 等 API，让调度器能直接读取设备属性。HAMi 当前主线仍基于 Device Plugin + annotations，但 chart 已包含可选 `dra.enabled` 和 `hami-dra` subchart 配置。
...
| 中文 README | <https://github.com/Project-HAMi/HAMi/blob/master/README_cn.md> |
| Design | <https://github.com/Project-HAMi/HAMi/blob/master/docs/develop/design.md> |
| Protocol | <https://github.com/Project-HAMi/HAMi/blob/master/docs/develop/protocol.md> |
