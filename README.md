...
| [Kubernetes-Blog-Feature-Deep-Dive.md](Kubernetes-Blog-Feature-Deep-Dive.md) | Kubernetes v1.37.0；RSS 截止 2026-09-06 | Kubernetes Blog/RSS 跨 SIG 新特性综述 | 需要理解 Kubernetes v1.36/v1.37 新 API、成熟度、升级和 AI 平台组合的工程师 | HPA Scale-to-Zero、DRA、Gang Scheduling、Storage Version Migration、RangeStream、证书、rootless、KYAML、Gateway API、Agent Sandbox |
...
- Kubernetes AI 平台：按 [Kubernetes-Blog-Feature-Deep-Dive.md](Kubernetes-Blog-Feature-Deep-Dive.md) → [Kubernetes-Native-Scheduler-Deep-Dive.md](Kubernetes-Native-Scheduler-Deep-Dive.md) → [Kubernetes-AI-Schedulers-Deep-Dive.md](Kubernetes-AI-Schedulers-Deep-Dive.md) → [Volcano-Upgrade-Compatibility-Deep-Dive.md](Volcano-Upgrade-Compatibility-Deep-Dive.md) → [KServe-Deep-Dive.md](KServe-Deep-Dive.md) / [Kubeflow-Deep-Dive.md](Kubeflow-Deep-Dive.md) 阅读；需要节点设备和共享隔离细节时，再补读 [NVIDIA-GPU-Operator-Deep-Dive.md](NVIDIA-GPU-Operator-Deep-Dive.md) 与 [HAMi-Deep-Dive.md](HAMi-Deep-Dive.md)。这条路径依次覆盖 Blog/RSS 新特性、原生调度基线、Kueue `v0.19.3`/Grove `alpha.13`/KAI `v0.17.1` AI 队列与调度扩展、Volcano 升级兼容、模型推理服务以及上层 MLOps 平台。
