...
DOCS = [
    ...
    },
    {
        ...
        "meta": "Dynamo v1.4.0 · source@0301494 · ModelExpress v0.5.0@0406ac1 · 2026-08-13",
    ...
    },
    {
        ...
        "meta": "Multica v0.4.26 · source@19155e4 · 2026-08-13",
    ...
    },
    {
        ...
        "meta": "AIPerf v0.12.0 · GuideLLM v0.7.3 · SGLang v0.5.17 · vLLM v0.27.1 · EvalScope v1.10.0 · 2026-08-13",
        "summary": "覆盖指标口径、AgentX/DAG replay、自适应压测、长上下文前缀、工具选型、SLO/goodput 与生产落地建议。",
        "footer": (
            '<a href="https://github.com/ai-dynamo/aiperf/tree/0e723bb8c984564cddf7274d19aab4eb7714f919">AIPerf v0.12.0 源码</a>、'
