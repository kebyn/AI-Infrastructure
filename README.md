...
**新稳定基线。** 本轮更新 Mooncake `v0.3.13.post1@719735896c86b56fabec6cf3e825fb2ea640597a`、Dynamo `v1.4.2@2ecbdfdf192c69c02c6d21e931d20d3b4a0bb64a`、Teleport `v18.10.0@ddaa46b8f4ee579d43480cd2d3b6a14b18e3ef7d`、Multica `v0.4.40@2cf5674d2e951db7733b622069e752b150dd6ab8`、vLLM `v0.28.0@2cf0a6915ce544dc493a0990f2ea38d81601128a`、EvalScope `v1.11.1@203cdc93137376df91814036bf99f486b5f4f3d1`、SGLang `v0.5.19@0bcd822377da7b5718e674eaf9c870d349424dd1`、Kubernetes `v1.37.0@f54c212e3a2f75d674b717a9b29052b20b60aefc`、Grove `v0.1.0-alpha.13@af2df1ffff0ae7a1135554564a6240a3f22f2c35`、Kueue `v0.19.3@2ade4776eadb571ecfba02f3680c4ef617a07e71`、KAI-Scheduler `v0.17.1@68dca3c4b8de3d9c433cf95c8f084372903ec84d` 与 Volcano `v1.15.2@1462fb7b4835970708717456e3aed85e697ec2eb`。重点包括 Teleport Auth/Proxy/Agent、短期证书、统一 RBAC、多协议审计与 Community/Enterprise 边界，Multica runs/Runtime/Autopilot/MCP 修复、SGLang beam/speculative/DeepEP v2/HiCache-L3 与压测缓存边界、Kubernetes Workload/PodGroup v1beta1、Grove PodGangMap 重建与 1:N 映射、Kueue v0.19.3 资源转换/DRA/准入修复、KAI v0.17.1 的 FIPS/DRA/eviction 修复，以及 Volcano GHSA-j38h-7pfq-cxmw 和调度修复。

**Teleport OSS 边界。** 新增 [Teleport OSS 深度技术文档](Teleport-Deep-Dive.md)，稳定基线是 2026-07-09 发布的最新正式 Release `v18.10.0`；其 lightweight tag 直接指向 `ddaa46b8f4ee579d43480cd2d3b6a14b18e3ef7d`。本文区分 GitHub 仓库 AGPL-3.0 源码、受 Teleport Community Edition License 与规模条件约束的官方 Community 预编译二进制，以及 Enterprise/Cloud entitlement；OIDC/SAML、资源级 JIT、Session/Identity Lock、Session Sharing/Moderation、Device Trust、Identity Security 和未发布 v19 不纳入 OSS 稳定承诺。
...
| [Teleport-Deep-Dive.md](Teleport-Deep-Dive.md) | `v18.10.0@ddaa46b` | Teleport OSS 基础设施身份与访问治理 | 负责 SSH/Kubernetes/数据库/App/Desktop/MCP 统一接入、短期证书和审计的平台与安全工程师 | Auth/Proxy/Agent、CA 与 Join、Role/标签/MFA、反向隧道、多协议审计、HA/恢复、Community license 和 Enterprise 边界 |
...
- 基础设施身份与访问治理：读 [Teleport-Deep-Dive.md](Teleport-Deep-Dive.md)。它说明如何用 Auth/Proxy/Agent、短期证书、Role/标签、MFA、反向隧道和审计统一保护 SSH、Kubernetes、数据库、内部应用、Desktop 与 MCP；Teleport 负责进入这些资源的身份和访问链，不替 Kubernetes/KServe/Kubeflow 的原生 RBAC、E2B 的 microVM 隔离、Multica 的 agent 协作编排或目标数据库/云 IAM 授权。
