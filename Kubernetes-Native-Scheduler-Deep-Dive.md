...
>
> 版本基线：Kubernetes `v1.37.0@f54c212e3a2f75d674b717a9b29052b20b60aefc`；审校日期：2026-09-06。`v1.37.0` 为 annotated tag，正文使用解引用后的 source commit，不使用 tag object。AI 调度器对照同步至 Kueue `v0.19.4`、Grove `v0.1.0-alpha.13` 与 KAI-Scheduler `v0.17.2`。
